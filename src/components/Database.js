...
export default function Database(){
    ...
    const createCollection = async ()=>{
        ...
        await dbClient.newCollection(threadID, {name:'Document', schema: documentSchema})
        await dbClient.newCollection(threadID, {name:'ProcedureMetaData', schema: procedureMetaData})
        await dbClient.newCollection(threadID, {name:'AgreementMetaData', schema: agreementMetaData})
